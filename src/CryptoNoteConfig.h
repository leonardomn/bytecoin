...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0x674d; // addresses start with "bRZ"
...
const uint64_t MONEY_SUPPLY                                  = static_cast<uint64_t>(10000000000);
...
const char     CRYPTONOTE_NAME[]                             = "brzcoin";
